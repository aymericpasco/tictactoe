...
bool GameEngine::checkWin(Player player) {
    ...
    for (int i = 0; i < 3; ++i)
        if((this->m_board[i][0] == id and this->m_board[i][1] == id and this->m_board[i][2] == id)
           or (this->m_board[0][i] == id and this->m_board[1][i] == id and this->m_board[2][i] == id))
            return true;

    if ((this->m_board[0][0] == id and this->m_board[1][1] == id and this->m_board[2][2] == id)
        or (this->m_board[0][2] == id and this->m_board[1][1] == id and this->m_board[2][0] == id))
        return true;
